...
## Profil et contexte de recherche

**Mohamed Doumbouya**  
Doctorant en Mathématiques Appliquées — Université Grenoble Alpes  
Équipe AIRSEA, Inria Grenoble

La recherche porte sur les méthodes computationnelles pour le Bayesian Optimal Experimental Design (BOED), avec un accent particulier sur les stratégies de placement de capteurs pour les modèles océaniques et les problèmes inverses à grande échelle.

L'objectif central est de développer des outils numériques et statistiques qui rendent le BOED tractable pour des systèmes géophysiques complexes, où les simulations forward sont coûteuses et l'espace des paramètres est de haute dimension. Les travaux combinent algèbre linéaire numérique, optimisation et quantification d'incertitude.

**Formation :**

- Mathématiques Appliquées et Modélisation — Polytech Lyon
- Post-master Calcul Haute Performance — Mines Paris – PSL

Cette double formation en calcul scientifique et HPC constitue le socle pour aborder les défis computationnels des modèles océaniques et climatiques, notamment dans le contexte de l'inférence à grande échelle et de l'assimilation de données.
