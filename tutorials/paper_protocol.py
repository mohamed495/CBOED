...
def main():
    ...
    p.add_argument("--n-gradient", type=int, default=1500)
    p.add_argument("--net-steps", type=int, default=500)
    p.add_argument("--nmc-n-outer", type=int, default=10000)
    p.add_argument("--nmc-n-inner", type=int, default=30000)
    p.add_argument("--nmc-n-inner-theta", type=int, default=20000)
